            ...
            if (in_array($fileActualExt, $fileAllowed)) {
                ...
                if (move_uploaded_file($tmp_file, 'img/patient/' . $new_patient_image)) {
                    try {
                        ...
                        // TODO
                        $newPatient = $patient->updatePatientInformation($patient_id ,$new_patient_firstName, $new_patient_lastName, $new_patient_dob, $new_patient_age, $new_patient_gender, $new_patient_status, $new_patient_er_response, $new_patient_allergy, $new_patient_room, $user_ins_ID, $user_id, $new_patient_image);
                ...
                echo "<script>
                    ...
                    window.location.href='edit-patient-information.php';
                    </script>";
            }
        }
    }
...
echo $twig->render(
    ...
    "edit-patient-information.html.twig",
    [
