...
mr_file.addEventListener('change', function() {
  ...
  reader.onload = function() {
    ...
    const displayAndCroppedImage_wrapper = document.querySelector('.displayAndCroppedImage-wrapper');
    const cropper_wrapper = document.querySelector('.cropper-wrapper');
    const source_image_wrapper = document.querySelector('.source-image-wrapper');

    if (myImage.src) {
      // cropper_wrapper.style.display='block';
      cropper_wrapper.setAttribute('class', 'd-flex mt-3 gap-2 justify-content-center');
      displayAndCroppedImage_wrapper.setAttribute('class', 'row mb-3 px-3 py-1 d-flex');
      
      source_image_wrapper.style.display='block';
    } else {
      cropper_wrapper.style.display='none';
      source_image_wrapper.style.display='none';
    }
      ...
      const cropper = new Cropper(myImage, {
        ...
        crop(event) { 
          cropBtn.addEventListener('click', () => {
            ...
            const displayed_image_wrapper = document.querySelector('.displayed-image-wrapper');
            if (dataUrl) {
              displayed_image_wrapper.style.display='block';
            } else displayed_image_wrapper.style.display='none';
